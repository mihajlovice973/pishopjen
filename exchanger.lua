...
-- FIX V3: все служебные сообщения только в нижней части экрана.
-- Последняя строка списка руды заканчивается выше STATUS_Y.
local STATUS_Y = h - 4       -- первая строка для двухстрочных ошибок/статуса
local STATUS_Y2 = h - 3      -- основная строка статуса / итог обмена
local PROMPT_Y = h - 2       -- "Для обмена встаньте на PIM..."
local SUBPROMPT_Y = h - 1    -- "Обновлю доступные руды..."
